            ...
            tooltip: {
              formatter: function () {
                return 'ios build size: <b>' + this.y + '</b> MB'+ '<br>' +
                    'version: <b>' + this.key +
                    '<br>' + "upload time:  " +
                    v_time_value_pairs[this.key] + '<br>' + '<br>'
                    + '<p><a color: #FF0000, href="http://build-01.dev.fusion.sparx.io:8080/view/SWAT%20Adhoc/job/SWAT%20Adhoc%20Android/">See what\'s new in this version</a></p>'
                    ;
              },
              useHTML: true
            }
            ...
            tooltip: {
              formatter: function () {
                return 'ios build size: <b>' + this.y + '</b> MB'+ '<br>' +
                    ...
                    '<br>' + "upload time:  " +
                    v_time_value_pairs[this.key] + '<br>' + '<br>'
                    + '<p><a color: #FF0000, href="http://build-01.dev.fusion.sparx.io:8080/view/SWAT%20Adhoc/job/SWAT%20Adhoc%20iOS/">See what\'s new in this version</a></p>'
                    ;
              },
              useHTML: true
            }
