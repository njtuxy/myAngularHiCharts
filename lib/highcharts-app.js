...
myapp.controller('mySwatAndroidBuildChart', function ($scope, $http) {
  $http.get("http://10.151.0.186:8080/SizeOnDiscDB/SizeOnDiscSwatAndroid?sort_by=-hockeyappid")
      .success(function(data){
        ...
        //$scope.fomattedTime1 =fomattedTime(1435101840);
            ...
            tooltip: {
              formatter: function () {
                return 'ios build size: <b>' + this.y + '</b> MB'+ '<br>' +
                    ...
                    + '<p><a color: #FF0000, href="http://build-01.dev.fusion.sparx.io:8080/job/SWAT%20Adhoc%20HockeyApp%20Android%20Upload/" target="_blank">See what\'s new in this version</a></p>'
                    ;
              },
              useHTML: true
            }
            ...
            tooltip: {
              formatter: function () {
                return 'ios build size: <b>' + this.y + '</b> MB'+ '<br>' +
                    ...
                    '<br>' +
                    "upload time:  <b> " + v_time_value_pairs[this.key] + '</b> <br> <br>'
                    + '<p><a color: #FF0000, href="http://build-01.dev.fusion.sparx.io:8080/view/SWAT%20Adhoc/job/SWAT%20Adhoc%20HockeyApp%20Upload/" target="_blank" >See what\'s new in this version</a></p>'
                    ;
              },
              useHTML: true
            }
